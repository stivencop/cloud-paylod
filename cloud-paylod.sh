...
fun_bar () {
         ...
         echo -e "\033[1;35m]\033[1;37m -\033[1;32m INSTALANDO!\033[1;37m"
         tput cnorm
		 echo -e "\033[1;31m---------------------------------------------------\033[1;37m"
        }
...
echo -e "\033[1;31m———————————————————————————————————————————————————\033[1;37m"
echo -e "\033[1;37mRequiere Estos Puertos Libres, 80 e 443"
echo
echo -e "\033[1;33m INSTANLADO SSL.. "
inst_ssl () {
pkill -f stunnel4
pkill -f stunnel
pkill -f 443
...
(echo br; echo br; echo uss; echo speed; echo pnl; echo SrSpartano; echo @SrSpartano)|openssl req -new -x509 -key key.pem -out cert.pem -days 1095 > /dev/null 2>&1
...
rm -rf proxy.py
echo
echo -e " \033[1;37m  Ahora Use Los Siguites Comandos O Use Su Script De Confianza"
echo -e " \033[1;37mpara Crear Un Usuario: CREARUSER "
echo -e " \033[1;37mpara Elimina Un Usuario: REMOUSER "
echo
echo
echo '
echo
...
echo '
echo
read -p "Digite El Nombre De Usuario A Eliminar :" user
